...
<div class="two-col">
    <div class="col">
        <div class="form-block">
            ...
            <div class="center" style="font-size:10px; margin:0 0 2.5px 0;">-------ooo-------</div>

            <div class="center" style="margin:2.5px 0 1.5px 0;">
                <span class="u-line u-name">{{ substr($employee_name ?? 'N/A', 0, 20) }}</span><br>
            ...
            <div style="margin-top:2.5px; font-size:9px; text-align: left; line-height: 1.6; width:92%; margin-left:auto; margin-right:auto;">
                <div style="margin-bottom:2px;">For the month of <span class="u-line u-month" style="min-width:100px;">{{ isset($daysData) && count($daysData) > 0 ? 'Month' : 'N/A' }}</span></div>
