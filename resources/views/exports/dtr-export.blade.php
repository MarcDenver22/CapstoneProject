    ...
    <div class="col">
        <div class="form-block">
            ...
            <div class="center" style="margin:2.5px 0 1.5px 0;">
                <span class="u-line u-name">{{ substr($user->name ?? '', 0, 20) }}</span><br>
            ...
            <div style="margin-top:2.5px; font-size:9px; text-align: left; line-height: 1.6; width:92%; margin-left:auto; margin-right:auto;">
                <div style="margin-bottom:2px;">For the month of <span class="u-line u-month" style="min-width:100px;">{{ \Carbon\Carbon::createFromFormat('m-Y', $month . '-' . $year)->format('M Y') }}</span></div>
