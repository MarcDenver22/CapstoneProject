...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="{{ route('hr.reports.export-csv', array_merge(request()->query(), ['type' => 'per-department'])) }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition flex items-center gap-2">
