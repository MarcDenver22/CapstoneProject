...
<div class="space-y-6">
        ...
        <div class="relative z-10">
            <div class="flex items-start gap-8">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-gray-600 text-lg font-medium mb-4"><span class="text-gray-500">{{ $profile['employee_id'] ?? 'N/A' }}</span> • <span class="text-gray-500">{{ $profile['department'] ?? 'N/A' }}</span></p>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-300">
        ...
        <div class="px-6 pt-4 flex gap-2 border-b border-gray-200">
            <button class="tab-btn active px-3 py-2 text-sm font-medium text-blue-600 border-b-2 border-blue-600 hover:text-blue-700" data-tab="announcements">
