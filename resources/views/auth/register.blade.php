...
<head>
    ...
    <meta name="description" content="PSU - Asingan Campus Attendance Management System Registration">
    <title>Register - PSU Attendance System</title>
        ...
        <div class="flex justify-center items-center min-h-screen">
            <div class="w-full max-w-md animate-slide-in">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Join our attendance management system</p>
                </div>
                    ...
                    @if ($errors->any())
                        <div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                            <div class="flex items-center gap-3 text-red-700">
                                ...
                                <div>
                                    <p class="font-semibold text-sm">Registration Failed</p>
