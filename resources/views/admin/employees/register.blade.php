...
@section('subheader', 'Register a new employee to the system')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        ...
        <p class="text-gray-600 mb-6">Please provide the employee's details to register</p>
        ...
        <div class="mt-6 text-center">
            <p class="text-gray-600 text-sm">
                <a href="{{ route('admin.employees.list') }}" class="text-blue-600 hover:text-blue-700 font-semibold">Back to employees</a>
            </p>
        </div>
    </div>
</div>
