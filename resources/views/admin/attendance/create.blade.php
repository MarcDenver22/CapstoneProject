...
@section('subheader', 'Create a new attendance entry')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form action="{{ route('admin.attendance.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="date" id="attendance_date" name="attendance_date" value="{{ old('attendance_date', now()->toDateString()) }}"
            ...
            <div>
                <label class="flex items-center gap-2">
                    <input type="checkbox" id="liveness_verified" name="liveness_verified" value="1"
                        {{ old('liveness_verified') ? 'checked' : '' }} class="rounded border-gray-300">
